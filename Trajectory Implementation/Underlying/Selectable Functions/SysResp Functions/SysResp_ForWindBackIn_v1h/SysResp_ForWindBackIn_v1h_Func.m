...
function [SYSRESP,err] = SysResp_ForWindBackIn_v1h_Func(SYSRESP,INPUT)
    ...
    for n = 1:SYSRESP.iterations 
        ...
        if strcmp(TST.SYSRESP.Vis,'Yes')
            ...
            if strcmp(fh.NumberTitle,'on')
                ...
                fh.NumberTitle = 'off';
                fh.Position = [200+TST.figshift 150 1400 800];
            end
