%==================================================================
% (v2b)
%   - negative to make data points multiple of 16
%==================================================================

classdef TrajSamp_SiemensStandard_v2b < handle

properties (SetAccess = private)                   
    Method = 'TrajSamp_SiemensStandard_v2b'
    TSMPipt
    DwellCrit
    MinBandPassOSamp
    DwellProt
...
% Constructor
%==================================================================  
function TSMP = TrajSamp_SiemensStandard_v2b(TSMPipt)    
...
function err = DefineTrajSamp(TSMP,DESTYPE,IMPMETH)    
    ...
    TSMP.Panel(2,:) = {'BandPassOverSamp',TSMP.BandPassOverSamp,'Output'};
    TSMP.Panel(3,:) = {'TotalOverSamp',TSMP.TrajOverSamp,'Output'};
end
