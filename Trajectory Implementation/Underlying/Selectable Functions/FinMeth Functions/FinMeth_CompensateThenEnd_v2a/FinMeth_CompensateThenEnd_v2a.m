...
classdef FinMeth_CompensateThenEnd_v2a < handle

properties (SetAccess = private)                   
    Method = 'FinMeth_CompensateThenEnd_v2a'
    FINMETHipt
    sysrespfunc
    SYSRESP
    CompDurPastGrad = 400
...
% Constructor
%==================================================================  
function FINMETH = FinMeth_CompensateThenEnd_v2a(FINMETHipt)    
...
function err = Finish(FINMETH,qkSpace,DESTYPE,IMPMETH)
    ...
    % End
    %----------------------------------------------------
    err = IMPMETH.TEND.EndTrajectories(FINMETH.SYSRESP.GradComp,DESTYPE);
    if err.flag
        return
    end
