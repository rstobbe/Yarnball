...
function [TEND,err] = TrajEnd_ConstantSpoil3Chan_v1d_Func(TEND,INPUT)
...
%---------------------------------------------
Gmomadd = TEND.spoilfactor/sqrt(3)*PROJdgn.kmax/PROJimp.gamma;
...
for n = 1:nproj
    for i = 1:3 
        ...
        if sol == 1
            [Grphs,err] = Solution1(Grphs,Gmomtraj,Gmomadd,Gend,dir,GrphsSgn,slope,gstep,TEND.gmax,n,i);
        else
            [Grphs,err] = Solution2(Grphs,Gmomtraj,Gmomadd,Gend,dir,GrphsSgn,slope,gstep,TEND.gmax,n,i);
        end
        if err.flag
            return
        end
