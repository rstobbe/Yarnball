%=====================================================
% (v1i)
%       - Just change to 'Vis' input to TST
%=====================================================

function [SCRPTipt,SYSRESP,err] = SysResp_FromFileWithComp_v1i(SCRPTipt,SYSRESPipt)
...
SYSRESP.errsmthkern = str2double(SYSRESPipt.('ErrSmoothKern'));
