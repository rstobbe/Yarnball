...
function [GVP,err] = GvelProf_NegHoldExp2Design_v1b_Func(GVP,INPUT)
...
magacc2(t0<GVP.hold/tro) = Acc0;
magacc2(t0>=GVP.hold/tro) = Acc0 .* exp(-(t0(t0>=GVP.hold/tro)-GVP.hold/tro)/GVP.tau); 
