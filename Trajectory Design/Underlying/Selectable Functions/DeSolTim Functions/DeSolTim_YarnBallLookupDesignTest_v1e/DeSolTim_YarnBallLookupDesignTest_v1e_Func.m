...
function [DESOL,err] = DeSolTim_YarnBallLookupDesignTest_v1e_Func(DESOL,INPUT)
...
[plout,err] = ProjLenOutside(DESTYPE.DESTRCT.p,DESTYPE.MaxRadSolve,DESTYPE.radevout);    
if DESTYPE.MaxRadSolve > 1
    [plout0,err] = ProjLenOutside(DESTYPE.DESTRCT.p,1,DESTYPE.radevout); 
else
    plout0 = plout;
end
if err.flag == 1
...
if strcmp(RADEV.soltype,'basic')
    [plin,err] = ProjLenInsideRapid(DESTYPE.DESTRCT.p,DESTYPE.radevin,RADEV.intol);     
else
    [plin,err] = ProjLenInside(DESTYPE.DESTRCT.p,DESTYPE.radevin);
end
if err.flag == 1
    return
end
...
T = (tautot/projlen0)*DESTYPE.DESTRCT.tro;
