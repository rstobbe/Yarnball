...
function [TURNSOL,err] = TurnSolution_NoOvershoot_v1a_Func(TURNSOL,INPUT)
...
% Design Params
%---------------------------------------------
TURNSOL.turnloc = 0.95;
TURNSOL.maxradderivative = 0.002;
TURNSOL.endrad = 1.00005;               % keep a tiny bit longer than 1.
...
%---------------------------------------------
n = 1;
for r = 0.90:0.00001:TURNSOL.MaxRadSolve+0.01
