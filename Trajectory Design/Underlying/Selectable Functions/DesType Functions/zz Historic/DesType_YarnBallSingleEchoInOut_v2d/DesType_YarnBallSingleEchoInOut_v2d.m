...
classdef DesType_YarnBallSingleEchoInOut_v2d < handle

properties (SetAccess = private)                   
    Method = 'DesType_YarnBallSingleEchoInOut_v2d'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallSingleEchoInOut_v2d(DESTYPEipt)
