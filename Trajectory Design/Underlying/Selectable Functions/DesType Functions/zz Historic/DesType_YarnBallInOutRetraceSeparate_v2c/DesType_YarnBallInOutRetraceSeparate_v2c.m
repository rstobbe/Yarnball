...
classdef DesType_YarnBallInOutRetraceSeparate_v2c < handle

properties (SetAccess = private)                   
    Method = 'DesType_YarnBallInOutRetraceSeparate_v2c'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallInOutRetraceSeparate_v2c(DESTYPEipt)
...
function Initialize(DESTYPE,SYS,NUC)
    ...
    DESTYPE.GENPRJ(2).SetTro(DESTYPE.KINFO(1).tro);
    ...
    DESTYPE.KINFO(1).SetDesignTimingStart(DESTYPE.RphsTro + DESTYPE.GradTimeQuant);
    DESTYPE.KINFO(2).SetDesignTimingStart(DESTYPE.KINFO(1).DesignTimingStart + DESTYPE.KINFO(1).tro + DESTYPE.GradTimeQuant);
...
function Test(DESTYPE)
    ...
    DESTYPE.Name = ['DES_F',sfov,'_V',svox,'_E',selip,'_T',stro,'_N',snproj,'_S',DESTYPE.GENPRJ(2).SPIN.name,'_RTIO']; 
