...
classdef DesType_YarnBallInOutRetrace_v2c < handle

properties (SetAccess = private)                   
    Method = 'DesType_YarnBallInOutRetrace_v2c'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallInOutRetrace_v2c(DESTYPEipt)
...
function Test(DESTYPE)
    ...
    stro = num2str(10*DESTYPE.Tro,'%03.0f');
