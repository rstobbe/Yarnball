%==================================================================
% (v2c)
%       - Matching 'YarnBallSingleEchoInOutRephase_v2c'
%==================================================================

classdef DesType_YarnBallSingleEchoInOutRephase_v2c < handle

properties (SetAccess = private)                   
    Method = 'DesType_YarnBallSingleEchoInOutRephase_v2c'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallSingleEchoInOutRephase_v2c(DESTYPEipt)
