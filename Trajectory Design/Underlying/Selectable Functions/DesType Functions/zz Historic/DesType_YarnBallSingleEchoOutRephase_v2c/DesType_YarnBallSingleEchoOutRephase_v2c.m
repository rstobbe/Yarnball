...
classdef DesType_YarnBallSingleEchoOutRephase_v2c < handle

properties (SetAccess = private)                   
    Method = 'YarnBallSingleEchoOutRephase_v2c'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallSingleEchoOutRephase_v2c(DESTYPEipt)
