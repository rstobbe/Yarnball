...
function [default] = DesType_YarnBallSingleEchoOutRephase_v2c_Default2(SCRPTPATHS)
...
default{m,1}.labelstr = 'OutFoV (mm)';
default{m,1}.entrystr = '230';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'OutVox (mm)';
default{m,1}.entrystr = '1.8';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'OutTro (ms)';
...
m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'OutTurnSlope';
default{m,1}.entrystr = '8';

m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'OutTurnEnd';
default{m,1}.entrystr = '1.0002';
