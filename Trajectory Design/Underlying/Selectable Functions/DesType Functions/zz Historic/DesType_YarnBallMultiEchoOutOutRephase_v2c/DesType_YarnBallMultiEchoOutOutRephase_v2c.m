%==================================================================
% (v2c)
%       - Matching 'YarnBallMultiEchoOutOutRephase_v2c'
%==================================================================

classdef DesType_YarnBallMultiEchoOutOutRephase_v2c < handle

properties (SetAccess = private)                   
    Method = 'DesType_YarnBallMultiEchoOutOutRephase_v2c'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallMultiEchoOutOutRephase_v2c(DESTYPEipt)
...
function Test(DESTYPE)
    ...
    DESTYPE.Name = ['DES_F',sfov,'_V',svox,'_E',selip,'_T',stro,'_N',snproj,'_S',DESTYPE.GENPRJ(1).SPIN.name,'_',sechos,'OOR']; 
