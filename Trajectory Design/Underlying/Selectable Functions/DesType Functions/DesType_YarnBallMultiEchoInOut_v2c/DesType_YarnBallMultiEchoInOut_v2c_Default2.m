...
function [default] = DesType_YarnBallMultiEchoInOutRephase_v2c_Default2(SCRPTPATHS)
...
ProjSampfunc = 'ProjSamp_InOutCombine_v2a';
...
m = m+1;
default{m,1}.entrytype = 'Input';
default{m,1}.labelstr = 'NumberOfEchos';
default{m,1}.entrystr = '2';
