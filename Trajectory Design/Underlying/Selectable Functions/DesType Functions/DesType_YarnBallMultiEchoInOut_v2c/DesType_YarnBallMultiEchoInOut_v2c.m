%==================================================================
% (v2c)
%       - Matching 'YarnBallMultiEchoInOut_v2c'
%==================================================================

classdef DesType_YarnBallMultiEchoInOut_v2c < handle

properties (SetAccess = private)                   
    Method = 'DesType_YarnBallMultiEchoInOut_v2c'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallMultiEchoInOut_v2c(DESTYPEipt)
...
function Test(DESTYPE)
    ...
    DESTYPE.Name = ['DES_F',sfov,'_V',svox,'_E',selip,'_T',stro,'_N',snproj,'_S',DESTYPE.GENPRJ(2).SPIN.name,'_',sechos,'IO']; 
