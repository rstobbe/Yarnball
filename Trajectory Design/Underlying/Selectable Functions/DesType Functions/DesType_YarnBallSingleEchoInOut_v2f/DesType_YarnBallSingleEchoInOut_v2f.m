...
classdef DesType_YarnBallSingleEchoInOut_v2f < handle

properties (SetAccess = private)                   
    Method = 'DesType_YarnBallSingleEchoInOut_v2f'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallSingleEchoInOut_v2f(DESTYPEipt)

    error('CenDel still to be added');
...
function Initialize(DESTYPE,SYS,NUC)
    ...
    % Update k-Space info 
    %---------------------------------------------
    DESTYPE.KINFO(1).SetNproj(DESTYPE.GENPRJ(1).SPIN.NumProj/2);        % because combining
