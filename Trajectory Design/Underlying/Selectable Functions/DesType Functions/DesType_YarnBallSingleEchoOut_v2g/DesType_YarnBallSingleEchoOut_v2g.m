%==================================================================
% (v2g)
%       - Change for 'Spin' function
%==================================================================

classdef DesType_YarnBallSingleEchoOut_v2g < handle

properties (SetAccess = private)                   
    Method = 'YarnBallSingleEchoOut_v2g'
    Name
    Panel
    DESTYPEipt
    TurnEvolutionFunc
...
% Constructor
%==================================================================  
function DESTYPE = DesType_YarnBallSingleEchoOut_v2g(DESTYPEipt)
...
function Initialize(DESTYPE,SYS,NUC)
    ...
    DESTYPE.GENPRJ(1).SetDir(-1);                                       % should switch... (not sure how this got 'backward')
    ...
    DESTYPE.GENPRJ(2).SPIN.SetDoSpin(0);
    ...
    DESTYPE.SamplingTro = DESTYPE.Tro + DESTYPE.RphsTro + DESTYPE.GradTimeQuant;
