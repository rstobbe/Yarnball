...
classdef kSpaceInfo_BasicHolder_v2b < handle

properties (SetAccess = private)                   
    Method = 'kSpaceInfo_BasicHolder_v2b'
    KINFOipt
    fov
    vox
    tro
...
% Constructor
%==================================================================  
function KINFO = kSpaceInfo_BasicHolder_v2b(KINFOipt)    
...
function SetSamplingPts(KINFO,SamplingPts)
    ...
    KINFO.SamplingArray = KINFO.SamplingPtStart + (0:1:KINFO.SamplingPts-1);
end
